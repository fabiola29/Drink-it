...
public class DrinkDB {
    ...
    public DrinkDB(Context appContext) {
  ...
  /*  public ArrayList<Boolean> getListBoolean(String key) {
    ...
    public ArrayList<DrinkDomain> getListObject(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<DrinkDomain> playerList = new ArrayList<DrinkDomain>();

        for (String jObjString : objStrings) {
            DrinkDomain player = gson.fromJson(jObjString, DrinkDomain.class);
  ...
  /*  public void putFloat(String key, float value) {
   ...
   /* public void putObject(String key, Object obj) {
    ...
    public void putListObject(String key, ArrayList<DrinkDomain> playerList) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (DrinkDomain player : playerList) {
